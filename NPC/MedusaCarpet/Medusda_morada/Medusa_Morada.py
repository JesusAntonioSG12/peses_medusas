        ...
        if Total_de_medusas_eliminadas >= 50 and self.medusa_morada_eliminada == False:
            ...
            if self.hitbox.colliderect(other_rect) and evento_1 == False:
                ...
                if self.Electrocutando == True and evento_1 == False:
                    if (keys[pygame.K_d] or keys[pygame.K_RIGHT]) and self.medusa_morada_posicion.x < Limite_Este:
                        self.medusa_morada_posicion.x += 20
                    
                    elif (keys[pygame.K_a] or keys[pygame.K_LEFT]) and self.medusa_morada_posicion.x > Limite_Oeste:
                        self.medusa_morada_posicion.x -= 20                
                    
                    elif (keys[pygame.K_s] or keys[pygame.K_DOWN]) and self.medusa_morada_posicion.y > Limite_Norte:
                        self.medusa_morada_posicion.y += 20
                    
                    elif (keys[pygame.K_w] or keys[pygame.K_UP]) and self.medusa_morada_posicion.y < Limite_Sur:
                        self.medusa_morada_posicion.y -= 20       
